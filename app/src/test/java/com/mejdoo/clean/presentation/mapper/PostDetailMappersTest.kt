...
class PostDetailMappersTest {
    ...
    fun `toPostDetail should map CombinedPostUserComments to PostDetail correctly`() {
        // Arrange
        val combined = CombinedPostUserComments(
    ...
    fun `toPostDetailList should map list of CombinedPostUserComments to list of PostDetail correctly`() {
        ...
        val combinedList = listOf(
            CombinedPostUserComments(
                post = Post(id = 101, userId = 10, title = "Post 1", body = "Body 1"),
                user = User(
                    id = 10,
                    name = "Alice",
                    email = "alice@mail.com",
                ...
                comments = listOf(
                    Comment(postId = 101, id = 1, name = "C1", email = "c1@mail.com", body = "B1")
                )
            ),
            CombinedPostUserComments(
                ...
                comments = listOf(
                    Comment(postId = 102, id = 2, name = "C2", email = "c2@mail.com", body = "B2"),
                    Comment(postId = 102, id = 3, name = "C3", email = "c3@mail.com", body = "B3")
                )
            )
        )
