@file:Suppress("FlowIsConstructedButNotUsed")
...
class PostDetailsUseCaseTest {
    ...
    @Test
    fun `invoke combines post, user and comments`() =
        runTest {
            val postId = 1
            val userId = 10
    ...
    @Test
    fun `invoke emits empty comments when repository returns empty`() =
        runTest {
            val postId = 1
            val userId = 10
